...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    double staticLinkSize = MediaQuery.of(context).size.width *
    ...
    Widget result = LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        Size titleSize = textPainterTitle.size;
        ...
        if (linkSize.width < maxWidth) {
          if (linkSize.width == textSize.width) {
            linkSize = Size(staticLinkSize, linkSize.height);
          }
          final pos = textPainter.getPositionForOffset(Offset(
            textSize.width -
                linkSize.width -
                (widget.title != null ? titleSize.width : 0),
            textSize.height,
          ));
        ...
        var textSpan;
        print('condition ${widget.trimLength < widget.data.length}');
        switch (widget.trimMode) {
          case TrimMode.Length:
            ...
            break;
          case TrimMode.Line:
            print('title Read :: ${widget.title}');
            print('title Read :: ${textPainter.didExceedMaxLines}');

            if (textPainter.didExceedMaxLines) {
              print('title Read MAX:: ${widget.title}');
