...
class DiamondSimilarItemWidget extends StatefulWidget {
  DiamondModel item;
  ActionClick actionClick;
  num leftPadding;
  num rightPadding;
  ...
  @override
  _DiamondSimilarItemWidgetState createState() =>
      _DiamondSimilarItemWidgetState();
}

class _DiamondSimilarItemWidgetState extends State<DiamondSimilarItemWidget> {
  final TextEditingController _offeredDiscountTextFieldController =
      TextEditingController();
  final TextEditingController _offeredPricePerCaratTextfieldContoller =
      TextEditingController();
...
//        Future.delayed(Duration(seconds: 1));
  ...
  @override
  void didUpdateWidget(covariant DiamondSimilarItemWidget oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.item.isNoteUpdated ?? false) {
      print('false');
      _noteController.text = widget.item.remarks;
