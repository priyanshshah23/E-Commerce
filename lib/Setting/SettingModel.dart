...
class DrawerSetting {
  ...
  static List<BottomTabModel> getMoreMenuItems(){
     List<BottomTabModel> moreMenuList = [];
      moreMenuList.add(BottomTabModel(
        image:enquiry,
        title: R.string().screenTitle.enquiry,
        type: MoreMenuModuleConstant.MODULE_TYPE_ENQUIRY
      ));
     moreMenuList.add(BottomTabModel(
         image:placeOrder,
         title: R.string().screenTitle.placeOrder,
         type: MoreMenuModuleConstant.MODULE_TYPE_PLACE_ORDER
     ));
     moreMenuList.add(BottomTabModel(
         image:addToCart,
         title: R.string().screenTitle.addToCart,
         type: MoreMenuModuleConstant.MODULE_TYPE_ADD_TO_CART
     ));
     moreMenuList.add(BottomTabModel(
         image:comment,
         title: R.string().screenTitle.comment,
         type: MoreMenuModuleConstant.MODULE_TYPE_COMMENT
     ));
     moreMenuList.add(BottomTabModel(
         image:offer,
         title: R.string().screenTitle.offer,
         type: MoreMenuModuleConstant.MODULE_TYPE_OFFER
     ));
     moreMenuList.add(BottomTabModel(
         image:company,
         title: R.string().screenTitle.officeView,
         type: MoreMenuModuleConstant.MODULE_TYPE_OFFER_VIEW
     ));
     moreMenuList.add(BottomTabModel(
         image:hold,
         title: R.string().screenTitle.hold,
         type: MoreMenuModuleConstant.MODULE_TYPE_HOLD
     ));
     moreMenuList.add(BottomTabModel(
         image:download,
         title: R.string().screenTitle.download,
         type: MoreMenuModuleConstant.MODULE_TYPE_DOWNLOAD
     ));
     moreMenuList.add(BottomTabModel(
         image:clearSelection,
         title: R.string().screenTitle.clearSelection,
         type: MoreMenuModuleConstant.MODULE_TYPE_CLEAR_SELECTION
     ));
     moreMenuList.add(BottomTabModel(
         image:share,
         title: R.string().screenTitle.share,
         type: MoreMenuModuleConstant.MODULE_TYPE_SHARE
     ));
     return moreMenuList;
  }
}